    ...
    void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit, 5f))
        {
            ...
            if (OVRInput.GetDown(OVRInput.Button.PrimaryHandTrigger, OVRInput.Controller.LTouch))
            {
                ...
                {
                    hit.collider.gameObject.transform.position = left_hand.transform.position + ray.direction * 0.1f;
                    hit.collider.gameObject.transform.parent = left_hand.transform;
